...
void GameMap::LoadMap(char* name)
{
    ...
    game_map_.strart_x_ = game_map_.strart_x_ =0;
...
void GameMap::DrawMap(SDL_Renderer* screen)
{
    ...
    map_x = game_map_.strart_x_ / TILE_SIZE;

    x1 = (game_map_.strart_x_ % TILE_SIZE)*-1;
    x2 = x1 + SCREEN_WIDTH + (x1 == 0 ? 0 : TILE_SIZE);

    map_y = game_map_.strart_y_ / TILE_SIZE;

    y1 = (game_map_.strart_y_%TILE_SIZE) * -1;
